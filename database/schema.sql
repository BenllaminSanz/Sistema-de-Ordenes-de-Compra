...
CREATE TABLE `requerimientos` (
  ...
  `datatextnow_id` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Referencia externa en DataTextNow',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `ordenes_compra` (
  ...
  `autorizado_por` int unsigned NOT NULL COMMENT 'Usuario con rol gerente que autorizó',
...
CREATE TABLE `recepciones` (
  ...
  `notas` text COLLATE utf8mb4_unicode_ci,
  `datatextnow_id` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Referencia de registro en DataTextNow',
