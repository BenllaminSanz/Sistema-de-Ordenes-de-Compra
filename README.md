...
**Versión 1.9.3** — Agosto 2026

Sistema web para la gestión completa del proceso de compras: **Requerimientos → Cotizaciones → Órdenes de Compra → Recepciones**.

Historial de cambios: [CHANGELOG.md](./CHANGELOG.md) · Cómo versionar: [VERSIONING.md](./VERSIONING.md) · Despliegue: [DESPLIEGUE-v1.9.3.md](./DESPLIEGUE-v1.9.3.md)
...
Guía paso a paso: **[DESPLIEGUE-v1.9.3.md](./DESPLIEGUE-v1.9.3.md)**
...
6. Verificar `GET /api/health` → version `1.9.3`
